/**
 * @file P2:CE Weapons API (V2 proposal)
...
interface GlobalEventNameMap {
	'WeaponDrop':						(weapon: uint32) => void,
	'WeaponPickup':						(weapon: uint32) => void,
	'WeaponFired':						(weapon: uint32, primary: boolean, ammo: uint32, clip: uint32) => void,

	'WeaponHUDSlotSelected':			(slot: uint32) => void,
	'WeaponHUDStateChanged':			(state: WeaponHUDState) => void,
}
